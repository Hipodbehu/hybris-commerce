...
import com.question.constants.QuestionConstants;



/**
 * This is the extension manager of the Question extension.
 */
public class QuestionManager extends GeneratedQuestionManager
{
	...
	{
		return (QuestionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QuestionConstants.EXTENSIONNAME);
	}
	...
	public QuestionManager() 
	{
		...
		{
			LOG.debug("constructor of QuestionManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QuestionManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QuestionManager called, current tenant: " + getTenant().getTenantID());
		}
	}
